...
export default function Login(props) {
    ...
    const [credentials, setCredentials] = useState({mobilno:"",password:""});
                                            ...
                                            <form action="" className="row g-4" onSubmit={handleSubmit}>
                                                <div className="col-12">
                                                    ...
                                                    <div className="input-group">
                                                        ...
                                                        //  min="10000000"
                                                         //max="99999999"
                                                         className="form-control" id="mobileno" name="mobileno" placeholder="Enter Your Mobile No" onChange={onChange} required/>
                                                    </div>
                                                </div>
